...
//On initialise la variable qui contiendra les 10 meilleurs joueurs.
$topPlayers = [];

if (isset($pdo)) {
    //On récupère ces 10 meilleurs joueurs dans la bdd.
...
<script>
    ...
    .then(data => {
        // Mise à jour du message de bienvenue ou gestions des erreurs
        document.getElementById('welcome-message').textContent = data;

        // Si l'inscription est réussie, on met à jour la variable currentPlayer
